import { B as BetterAuthOptions, T as TelemetryContext, E as TelemetryEvent, J as FieldAttribute, M as Models } from './shared/better-auth.DZfsKi2z.cjs';
export { O as Account, a as Adapter, Z as AdapterInstance, Y as AdapterSchemaCreation, N as AdditionalSessionFieldsInput, i as AdditionalSessionFieldsOutput, m as AdditionalUserFieldsInput, j as AdditionalUserFieldsOutput, c as Auth, d as AuthContext, v as AuthPluginSchema, n as BetterAuthPlugin, F as FilterActions, $ as FilteredAPI, G as GenericEndpointContext, H as HookEndpointContext, h as InferAPI, I as InferOptionSchema, p as InferPluginErrorCodes, o as InferPluginTypes, f as InferSession, a0 as InferSessionAPI, e as InferUser, a6 as InternalLogger, a5 as LogHandlerParams, a1 as LogLevel, a4 as Logger, R as RateLimit, _ as SecondaryStorage, S as Session, X as TransactionAdapter, U as User, V as Verification, Q as Where, W as WithJsDoc, L as betterAuth, a7 as createLogger, P as init, a2 as levels, a8 as logger, a3 as shouldPublishLog } from './shared/better-auth.DZfsKi2z.cjs';
export { A as AtomListener, B as BetterAuthClientPlugin, C as ClientOptions, b as InferActions, i as InferAdditionalFromClient, a as InferClientAPI, c as InferErrorCodes, f as InferPluginsFromClient, g as InferSessionFromClient, h as InferUserFromClient, I as IsSignal, S as SessionQueryParams, e as Store } from './shared/better-auth.Cl7sGL_Z.cjs';
export { H as HIDE_METADATA } from './shared/better-auth.DEHJp1rk.cjs';
export { g as generateState, p as parseState } from './shared/better-auth.DLM3kjPd.cjs';
...
declare function getTelemetryAuthConfig(options: BetterAuthOptions, context?: TelemetryContext): {
    ...
    account: {
        modelName: string | undefined;
        fields: Partial<Record<"scope" | "accessToken" | "refreshToken" | "accessTokenExpiresAt" | "refreshTokenExpiresAt" | "idToken" | "createdAt" | "updatedAt" | "userId" | "password" | "providerId" | "accountId", string>> | undefined;
