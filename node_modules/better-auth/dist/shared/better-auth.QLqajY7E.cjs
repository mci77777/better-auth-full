...
const getMigration = require('./better-auth.CbV2Bzor.cjs');
...
const socialProviders_index = require('./better-auth.BaoSQduK.cjs');
...
const kyselyAdapter = require('./better-auth.BfH-lFD6.cjs');
